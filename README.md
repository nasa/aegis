...
2. Pick a strong password for `AEGIS_DB_PASS`
...
1. Run migrations: `npm run migrate:up` to create the tables in the database.
2. Run `npm run seed` to seed the database with some test data.
