...
- Stop the `aegis-database-1` container
- Delete your `./.local/database` directory
- Retrieve dump from CI/CD using artifacts generated by one of the export jobs such as `z:db-import:dev1`. This files is called `aegis.sql`
- Start the `aegis-database-1` container
