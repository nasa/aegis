...
export const setupMaestroNamespace = (
  ...
  const maestroNamespace = io.of("/maestro") as unknown as Namespace<
    ...
    {}
  >;
  globalValues.maestroV1.socketio = maestroNamespace;
    ...
    (
      ...
      socket.on("missionJoin", (missionId: number, maestroVisitor: MaestroVisitor) => {
        ...
        if (!globalValues.maestroV1.visitorData[missionId]) {
          globalValues.maestroV1.visitorData[missionId] = [];
        }
        const maestroVisitors = globalValues.maestroV1.visitorData[missionId];
      ...
      socket.on(
        ...
        async (missionId: number, evaRefUuid: string, rexUuid: string | null) => {
          ...
          if (!subscriptions.includes(evaUuid)) {
            ...
            globalValues.maestroV1.evaSubscriptions.set(missionId, subscriptions);
          }
        }
      );
      ...
      // Summary of Maestro v1 information for the admin inspector
