...
class CompassComplex:
    ...
    compass["northeast by north"] = compass["NEbN"] = northeast_by_north = NEbN = CompassPoint(
    ...
    compass["northeast by east"] = compass["NEbE"] = northeast_by_east = NEbE = CompassPoint(
    ...
    compass["southeast by east"] = compass["SEbE"] = southeast_by_east = SEbE = CompassPoint(
    ...
    compass["southeast by south"] = compass["SEbS"] = southeast_by_south = SEbS = CompassPoint(
    ...
    compass["southwest by south"] = compass["SWbS"] = southwest_by_south = SWbS = CompassPoint(
    ...
    compass["southwest by west"] = compass["SWbW"] = southwest_by_west = SWbW = CompassPoint(
    ...
    compass["northwest by west"] = compass["NWbW"] = northwest_by_west = NWbW = CompassPoint(
    ...
    compass["northwest by north"] = compass["NWbN"] = northwest_by_north = NWbN = CompassPoint(
