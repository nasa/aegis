...
vi.mock("http-client/stm", () => ({
  upsertStmRules: vi.fn().mockImplementation(async (stmRules: STMRule[]) => {
  ...
  deleteStmRules: vi.fn().mockImplementation(async (stmRuleUuids: string[]) => {
