...
beforeAll(async () => {
  ...
  testAutomergeDocListings = await new DocListingFactory(em)
    .each((record, index) => {
      record.automergeUrl = `automerge:JestTestMission${index + 1}`;
    })
    .create(3);
  ...
  testMissionsPartial = [
    {
      ...
      name: "Jest Test Mission 1",
      isArchived: false,
      actionSystemVersion: 2,
    },
    {
      id: testAutomergeDocListings[1].missionId,
      name: "Jest Test Mission 2",
      isArchived: false,
      actionSystemVersion: 2,
    },
    {
      id: testAutomergeDocListings[2].missionId,
      name: "Jest Test Mission 3", // this mission is a v1 mission
      isArchived: false,
