...
REFERENCE_TAG = "v0.3.0"
REFERENCE_COMMIT = "6ba953e09e5dde9d379df5b2c1a91b7b958fb851"
REFERENCE_REPOSITORY = "https://github.com/rbeyer/lgrs"
...
def reference_label(easting: float, northing: float, precision: int) -> dict | None:
...
def point_case(easting: float, northing: float, precision: int, category: str) -> dict:
    ...
    return {
        ...
        "expected": reference_label(serialized_easting, serialized_northing, precision),
    }
    ...
    if labels_visible:
        ...
        for northing in range(
            ...
            for easting in range(
                ...
                expected = reference_label(easting, northing, precision)
                if expected:
                    labels.append(
...
def generate(output: Path) -> None:
    ...
    metadata = {
        ...
        "command": "pixi run lgrs-reference-corpus",
        "seed": SEED,
